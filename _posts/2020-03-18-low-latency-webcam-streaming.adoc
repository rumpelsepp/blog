...
This is quite challenging when you have to make sure that devicess can be powercycled reliably.
...
During my testing a need visual feedback for what I am doing, i.e. "hit enter, look at the power consumption. Anything changed?".
